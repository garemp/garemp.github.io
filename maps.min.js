...
function(b){$("#type-pane").hide();$("#prop-pane").hide();clean=!0;$("#legend-pane").hide();mobile_dev?$("#search-box").val(""):$("#search-box").focus().val("");offset=0;cur_neig=cur_node=null;$("#mapr-relmap").html("");$("#mapr-rel").html("");$("#mapr-reldiv").hide()}),sigma.parsers.json("maps.json",s,function(){filter=new sigma.plugins.filter(s);var b,a=s.graph.nodes(),c=a.length;for(b=0;b<c;b++)a[b].cat1viz=!0,a[b].cat2viz=!0,a[b].yearviz=!0;for(b=0;b<c;b++)a[b].size=7,a[b].color=a[b].center?"#333":
"#AAA",a[b].colorf="#AAA",a[b].colorg="#AAA";c=s.graph.edges();var e=c.length;for(b=0;b<e;b++)c[b].type="curve",c[b].defaultcolor=c[b].color;s.refresh();for(b=0;b<e;b++)"curved"==c[b].attributes[0]&&(c[b].type="curvedArrow");s.refresh();updateCountinfo(a.length);nolegendfornodes()}))})});var type_append=!1,prop_append=!1;offset=0;cur_neig=cur_node=null;var clean=!0,nextptr=1,ptrlen=0,neighbor;
...
"image",a.url="img/g,y.png",a.colorf="#00CC00",a.colorg="#CCCC00"):"pseudoazimuthal"==a.attributes[i]?(d=!0,a.type="image",a.url="img/mby.png"):"miscellaneous"==a.attributes[i]?(d=!0,a.color="#AAA"):"polyhedral"==a.attributes[i]&&(d=!0,a.type="image",a.url="img/icosa.png"),"Aitoff"==a.label||"Wagner 7"==a.label||"Wagner 8"==a.label||"Wagner 9"==a.label)d=!0,a.type="image",a.url=uselent?"img/mbo.png":"img/b,o.png";else if("Hammer"==a.label||"Winkel 3"==a.label)d=!0,a.type="image",a.url=uselent?"img/mbok.png":
"img/bok.png";else if("Ortelius Oval"==a.label||"Apian Globular I"==a.label||"Bacon Globular"==a.label)d=!0,a.type="image",a.url="img/ryk.png";else if("Strebe 1995"==a.label)d=!0,a.type="image",a.url="img/m-o.png";else{if("Ciric I"==a.label||"A4"==a.label||"Dedistort"==a.label)d=!0,a.color="#F0F"}else{if("same shape"==c&&a.attributes[i].startsWith("same shape g")){val=a.attributes[i].substring(12);d=!0;a.type="image";a.url="img/g"+val+".png";switch(val.substring(0,1)){case "g":a.colorf="#3cb44b";
break;case "y":a.colorf="#ffe119";break;case "b":a.colorf="#4363d8";break;case "o":a.colorf="#f58231";break;case "c":a.colorf="#42d4f4";break;case "m":a.colorf="#f032e6"}switch(val.substring(1)){case "g":a.colorg="#3cb44b";break;case "y":a.colorg="#ffe119";break;case "b":a.colorg="#4363d8";break;case "o":a.colorg="#f58231";break;case "c":a.colorg="#42d4f4";break;case "m":a.colorg="#f032e6"}}if("similar shape"==c){a.attributes[i].startsWith("cylindrical equal-area")&&(d=!0,a.type="image",a.url="img/c,m.png",
a.colorf="#00cccc",a.colorg="#cc00cc");"Sinusoidal"==a.label&&(d=!0,a.type="image",a.url="img/gpb,g.png",a.colorf="#0000cc",a.colorg="#00cc00");"Boggs eumorphic"==a.label&&(d=!0,a.type="image",a.url="img/g-r.png",a.colorf="#00cc00",a.colorg="#cc0000");"Siemon IV"==a.label&&(d=!0,a.type="image",a.url="img/g-rk.png",a.colorf="#00cc00",a.colorg="#cc0000");if("Putni\u0146\u0161 P1"==a.label||"Putni\u0146\u0161 P2"==a.label)d=!0,a.type="image",a.url="img/gray-r.png",a.colorf="#ffe119",a.colorg="#cc0000";
if("Putni\u0146\u0161 P3'"==a.label||"Putni\u0146\u0161 P4'"==a.label)d=!0,a.type="image",a.url="img/gray-ok.png",a.colorf="#ffe119",a.colorg="#f88018";if("Wagner 1"==a.label||"Wagner 2"==a.label||"Wagner 3"==a.label)d=!0,a.type="image",a.url="img/gray-o.png",a.colorf="#ffe119",a.colorg="#f88018"}if("combinations"==c){if("fusion-src"==a.attributes[i]||"blending-src"==a.attributes[i]||"const-src"==a.attributes[i])d=!0,a.type="def",a.color=colormap[0];if("Hammer"==a.label||"Aitoff"==a.label)a.type=
"image",a.url="img/r,m.png",a.colorf="#CC0000",a.colorg="#CC00CC";"Mollweide"==a.label&&(a.type="image",a.url="img/r,c.png",a.colorf="#CC0000",a.colorg="#00CCCC");"Collignon"==a.label&&(a.type="image",a.url="img/c,r.png",a.colorf="#00CCCC",a.colorg="#CC0000")}a.attributes[i]==b&&(d=!0,"combinations"==c?(a.type="def",a.color=colormap[h+1]):"distortions"==c?"Sinusoidal"==a.label||"Werner"==a.label?(a.type="image",a.url="img/gpb,g.png",a.colorf="#0000CC",a.colorg="#00CC00"):(a.type="def",a.color=colormap[h]):
(a.type="def",a.color=colormap[h]))}});0==a.colorf&&(a.colorf=a.color);0==a.colorg&&(a.colorg=a.color);return{found:d,type:a.type,color:a.color,colorf:a.colorf,colorg:a.colorg,url:a.url}}
...
a.label)c=!0,a.type="image",a.url="img/gray-r.png";if("Putni\u0146\u0161 P3'"==a.label||"Putni\u0146\u0161 P4'"==a.label)c=!0,a.type="image",a.url="img/gray-ok.png";if("Wagner 1"==a.label||"Wagner 2"==a.label||"Wagner 3"==a.label)c=!0,a.type="image",a.url="img/gray-o.png"}if("(may be) interrupted"==sel||"Bonne group"==sel)"Sinusoidal"==a.label&&(c=!0,a.type="image",a.url="img/gpb,g.png"),"Boggs eumorphic"==a.label&&(c=!0,a.type="image",a.url="img/g-r.png"),"Siemon IV"==a.label&&(c=!0,a.type="image",
a.url="img/g-rk.png");"cylindrical equal-area family"!=sel&&"stretching"!=sel||!a.attributes[i].startsWith("cylindrical equal-area")||(c=!0,a.type="image",a.url="img/c,m.png");if("fusion"==sel&&"fusion-src"==a.attributes[i]||"blending"==sel&&"blending-src"==a.attributes[i]||"construction"==sel&&"const-src"==a.attributes[i]){if("fusion-src"==a.attributes[i]||"blending-src"==a.attributes[i]||"const-src"==a.attributes[i])c=!0,a.type="def",a.color=colormap[0];if("Hammer"==a.label||"Aitoff"==a.label)a.type=
"image",a.url="img/r,m.png";"Mollweide"==a.label&&(a.type="image",a.url="img/r,c.png");"Collignon"==a.label&&(a.type="image",a.url="img/c,r.png")}}c||(a.cat1viz=!1);c&&a.cat2viz&&b++;return c&&a.cat2viz&&a.yearviz},"categories").apply();updateCountinfo(b)}
