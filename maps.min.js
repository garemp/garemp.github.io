...
"-pane").stop().fadeOut(3E3)});$(".popup-div").mouseover(function(){$(this).stop().fadeIn();return!1});$(".popup-div").mouseout(function(){$(this).stop().fadeOut(3E3);return!1});var b=$(document).height(),c=$(document).width();c<b?($("#autofade").css({height:"150"}),$("#autofade").html('<div style="text-align: center;position: relative;top:10%; font-size: 24px; color: #f4f0e4;">Warning: You may view on <span style="border: solid 1px;color: #f4f0e4;">mobile</span> device, some contents may be not optimized appropriately.</div>'),
mobile_dev=!0,$("#search-box").attr("disabled","disabled"),$("<br>").insertBefore("#uselent"),$("#button-pane").css({right:"10px"})):(1280>c||600>b)&&$("#autofade").html('<div style="text-align: center;position: relative;top:10%; font-size: 24px; color: #f4f0e4;">Warning: Screen resolusion may be too <span style="border: solid 1px;color: #f4f0e4;">low</span> to render contents.</div>');1360!=c&&1366!=c&&1440!=c&&1536!=c&&1600!=c&&1680!=c||768!=b&&800!=b&&864!=b&&900!=b&&1024!=b&&1050!=b?$("#autofade").hide().fadeIn(2E3).delay(3E3).fadeOut(3E3):
$("#autofade").hide()});
