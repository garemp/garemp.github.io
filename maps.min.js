...
1<ptrlen&&$("#rel-area").append('<div style="text-align:center"><button id="prev-btn">prev relations</button></div>');var a=b.img,c=nodes[visnb[nextptr]].img;var d=b.name?b.name:b.label+" projection";var e=nodes[visnb[nextptr]].name?nodes[visnb[nextptr]].name:nodes[visnb[nextptr]].label+" projection";$("#comp-div").empty().hide();$("#comp-btn").click(function(){$("#comp-div").append("<span id='comp-name'>"+d+"</span><img id='comp-close' width='20px' style='float: right;' src='img/cross.svg'><br><img id='comp-img' height='300px' src="+
