...
"img/bok.png";else if("Ortelius Oval"==a.label||"Apian Globular I"==a.label||"Bacon Globular"==a.label)d=!0,a.type="image",a.url="img/ryk.png";else if("Strebe 1995"==a.label)d=!0,a.type="image",a.url="img/m-o.png";else{if("Ciric I"==a.label||"A4"==a.label||"Dedistort"==a.label)d=!0,a.color="#F0F"}else{"same shape"==c&&a.attributes[i].startsWith("same shape gp")&&(val=a.attributes[i].substring(13),d=!0,a.type="image",a.url="img/gp"+val+".png");if("similar shape"==c){a.attributes[i].startsWith("cylindrical equal-area")&&
(d=!0,a.type="image",a.url="img/c,m.png");"Sinusoidal"==a.label&&(d=!0,a.type="image",a.url="img/gpb,g.png");"Boggs eumorphic"==a.label&&(d=!0,a.type="image",a.url="img/g-r.png");"Siemon IV"==a.label&&(d=!0,a.type="image",a.url="img/g-rk.png");if("Putni\u0146\u0161 P1"==a.label||"Putni\u0146\u0161 P2"==a.label)d=!0,a.type="image",a.url="img/gray-r.png";if("Putni\u0146\u0161 P3'"==a.label||"Putni\u0146\u0161 P4'"==a.label)d=!0,a.type="image",a.url="img/gray-ok.png";if("Wagner 1"==a.label||"Wagner 2"==
a.label||"Wagner 3"==a.label)d=!0,a.type="image",a.url="img/gray-o.png"}if("combinations"==c){if("fusion-src"==a.attributes[i]||"blending-src"==a.attributes[i]||"const-src"==a.attributes[i])d=!0,a.type="def",a.color=colormap[0];if("Hammer"==a.label||"Aitoff"==a.label)a.type="image",a.url="img/r,m.png",a.colorf="#CC0000",a.colorg="#CC00CC";"Mollweide"==a.label&&(a.type="image",a.url="img/r,c.png",a.colorf="#CC0000",a.colorg="#00CCCC");"Collignon"==a.label&&(a.type="image",a.url="img/c,r.png",a.colorf=
"#00CCCC",a.colorg="#CC0000")}a.attributes[i]==b&&(d=!0,"combinations"==c?(a.type="def",a.color=colormap[h+1]):"distortions"==c?"Sinusoidal"==a.label||"Werner"==a.label?(a.type="image",a.url="img/gpb,g.png",a.colorf="#0000CC",a.colorg="#00CC00"):(a.type="def",a.color=colormap[h]):(a.type="def",a.color=colormap[h]))}});0==a.colorf&&(a.colorf=a.color);0==a.colorg&&(a.colorg=a.color);return{found:d,type:a.type,color:a.color,colorf:a.colorf,colorg:a.colorg,url:a.url}}
function catChange(){$("#main-pane").empty();$("#minor-pane").empty();nodes=s.graph.nodes();edges=s.graph.edges();sel=$(this).val();for(i=0;i<nodes.length;i++)nodes[i].cat1viz=!0;if("all categories"==sel)$("#cat-l2").empty(),$("#cat-l2").append("<option>no sub-categories</option>"),filter.undo("categories").nodesBy(function(a){a.type="def";a.type2=a.type;a.color="#AAA";a.color2=a.color;a.colorf=a.color;a.colorg=a.color;return a.cat2viz},"categories").apply(),nolegendfornodes();else{var c=sub_categories.get(sel);
$("#cat-l2").empty();$("#cat-l2").append("<option>all sub-categories</option>");Object.values(c).forEach(function(a){$("#cat-l2").append("<option>"+a+"</option>")});var b=0;filter.undo("categories").nodesBy(function(a){var d=!1;ret=catFilter(sel,c,a);ret.found&&(d=!0);a.type=ret.type;a.color=ret.color;a.url=ret.url;a.type2=ret.type;a.color2=ret.color;a.url2=ret.url;a.colorf=ret.colorf;a.colorg=ret.colorg;d||(a.cat1viz=!1);d&&a.cat2viz&&b++;return d&&a.cat2viz&&a.yearviz},"categories").apply();updateCountinfo(b);
updateColorinfo(sel,c)}}
...
(c=!0,a.type="image",a.url="img/c,m.png");if("fusion"==sel&&"fusion-src"==a.attributes[i]||"blending"==sel&&"blending-src"==a.attributes[i]||"construction"==sel&&"const-src"==a.attributes[i]){if("fusion-src"==a.attributes[i]||"blending-src"==a.attributes[i]||"const-src"==a.attributes[i])c=!0,a.type="def",a.color=colormap[0];if("Hammer"==a.label||"Aitoff"==a.label)a.type="image",a.url="img/r,m.png";"Mollweide"==a.label&&(a.type="image",a.url="img/r,c.png");"Collignon"==a.label&&(a.type="image",a.url=
"img/c,r.png")}}c||(a.cat1viz=!1);c&&a.cat2viz&&b++;return c&&a.cat2viz&&a.yearviz},"categories").apply();updateCountinfo(b)}
