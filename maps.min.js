...
$(document).ready(function(){$("#search-pane").css("left",parseInt($("#main-pane").css("width"))+30);$("#search-box").bind("change",search).focus();$("#cat-l1").change(catChange);$("#cat-l2").change(subcatChange);$("#cat-more").change(morecatChange);$("#reset-all").click(catReset);$("#uselent").change(function(){uselent=!uselent;$("#cat-more").empty();$("#cat-more").append("<option>== no more filters ==</option>");$("#cat-more").append("<option>cylindrical</option>");$("#cat-more").append("<option>pseudocylindrical</option>");
$("#cat-more").append("<option>conic</option>");$("#cat-more").append("<option>pseudoconic</option>");$("#cat-more").append("<option>azimuthal</option>");uselent&&$("#cat-more").append("<option>lenticular</option>");$("#cat-more").append("<option>== no more filters ==</option>");$("#cat-more").append("<option>conformal</option>");$("#cat-more").append("<option>equal-area</option>");$("#cat-more").append("<option>equidistant</option>");$("#cat-more").append("<option>compromise</option>");$("#reset-all").click();
uselent?sub_categories.set("developable surfaces","cylindrical conic azimuthal pseudocylindrical pseudoconic polyconic lenticular miscellaneous".split(" ")):sub_categories.set("developable surfaces","cylindrical conic azimuthal pseudocylindrical pseudoconic polyconic miscellaneous".split(" "))});$("#drawcvco").change(function(){nodes=s.graph.nodes();edges=s.graph.edges();if(drawcvco=!drawcvco)for(j=0;j<edges.length;j++)edges[j].color=edges[j].defaultcolor;else for(j=0;j<edges.length;j++)edges[j].color=
