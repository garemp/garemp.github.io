...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(b,a){var c=$jscomp.checkStringArgs(this,b,"startsWith");b+="";var e=c.length,h=b.length;a=Math.max(0,Math.min(a|0,c.length));for(var f=0;f<h&&a<e;)if(c[a++]!=b[f++])return!1;return f>=h}},"es6","es3");var s,loaded=0,mobile_dev=!1;drawcvco=!0;uselent=!1;sigma.utils.pkg("sigma.canvas.nodes");
...
!1;year=a.year;var c=/c.a./i;c.test(year)&&(year=year.replace("c.a.",""));year=parseInt(year);c=/BC/i;c.test(a.year)&&(year=-year);c=/and/i;c.test(a.year)?(split=a.year.split(" and "),y0=parseInt(split[0]),y1=parseInt(split[1]),y0>=d&&y0<=e&&(b=!0),y1>=d&&y1<=e&&(b=!0)):year>=d&&year<=e&&(b=!0);b&&k++;b||(a.yearviz=!1);return b},"yearrange").apply();updateCountinfo(k)}});var c=b[$("#slider-range").slider("values",0)],a=b[$("#slider-range").slider("values",1)];0>a?$("#amount").val(-c+"BC - "+-a+"BC"):
...
function(b){$("#type-pane").hide();$("#prop-pane").hide();clean=!0;$("#legend-pane").hide();mobile_dev?$("#search-box").val(""):$("#search-box").focus().val("");offset=0;cur_neig=cur_node=null;$("#mapr-relmap").html("");$("#mapr-rel").html("");$("#mapr-reldiv").hide()}),sigma.parsers.json("maps.json",s,function(){filter=new sigma.plugins.filter(s);var b,a=s.graph.nodes(),d=a.length;for(b=0;b<d;b++)a[b].cat1viz=!0,a[b].cat2viz=!0,a[b].yearviz=!0;for(b=0;b<d;b++)a[b].color=a[b].center?"#333":"#666";
a=s.graph.edges();d=a.length;for(b=0;b<d;b++)a[b].type="curve",a[b].defaultcolor=a[b].color;$("#uselent").change();s.refresh();for(b=0;b<d;b++)"curved"==a[b].attributes[0]&&(a[b].type="curvedArrow");s.refresh();updateCountinfo(102);nolegendfornodes()}))})});var type_append=!1,prop_append=!1;offset=0;cur_neig=cur_node=null;var clean=!0,nextptr=1,ptrlen=0,neighbor;
...
a+"</option>")});var c=0;filter.undo("categories").nodesBy(function(a){var d=!1;ret=catFilter(sel,b,a);ret.found&&(d=!0);a.type=ret.type;a.color=ret.color;a.url=ret.url;d||(a.cat1viz=!1);d&&a.cat2viz&&c++;return d&&a.cat2viz&&a.yearviz},"categories").apply();updateCountinfo(c);updateColorinfo(sel,b)}}
function subcatChange(){$("#main-pane").empty();$("#minor-pane").empty();sel=$(this).val();idx=this.selectedIndex-1;for(i=0;i<nodes.length;i++)nodes[i].cat1viz=!0;if("all sub-categories"==sel){parsel=$("#cat-l1").val();var b=sub_categories.get(parsel),c=0;filter.undo("categories").nodesBy(function(a){var d=!1;ret=catFilter(parsel,b,a);ret.found&&(d=!0);a.type=ret.type;a.color=ret.color;a.url=ret.url;d||(a.cat1viz=!1);d&&a.cat2viz&&c++;return d&&a.cat2viz&&a.yearviz},"categories").apply()}else c=0,
filter.undo("categories").nodesBy(function(a){var b=!1;for(i=0;i<Object.values(a.attributes).length;i++){a.attributes[i]==sel&&(b=!0,a.type="def",a.color=colormap[idx],"fusion"==sel||"blending"==sel||"construction"==sel)&&(a.color=colormap[idx+1]);"cylindrical"==sel&&(a.color=colormap[0]);"conic"==sel&&(a.color=colormap[1]);"azimuthal"==sel&&(a.color=colormap[2]);"pseudocylindrical"==sel&&(a.type="image",a.url="img/r,y.png","Ortelius Oval"==a.label||"Apian Globular I"==a.label||"Bacon Globular"==
a.label)&&(b=!0,a.type="image",a.url="img/ryk.png");"pseudoconic"==sel&&(a.type="image",a.url="img/g,y.png");"polyconic"==sel&&"Strebe 1995"==a.label&&(a.type="image",a.url="img/m-o.png");if("pseudoazimuthal"==sel){a.type="image";a.url="img/mby.png";if("Hammer"==a.label||"Winkel 3"==a.label)b=!0,a.type="image",a.url=uselent?"img/mbok.png":"img/bok.png";if("Aitoff"==a.label||"Wagner 7"==a.label||"Wagner 8"==a.label||"Wagner 9"==a.label)a.type="image",a.url=uselent?"img/mbo.png":"img/b,o.png"}"miscellaneous"==
sel&&(a.color="#000","Hammer"==a.label||"Winkel 3"==a.label)&&(a.type="image",a.url=uselent?"img/mbok.png":"img/bok.png");"polyhedral"==sel&&(a.type="image",a.url="img/icosa.png");if("equal-area"==sel||"equidistant"==sel)if("Sinusoidal"==a.label||"Werner"==a.label)a.type="image",a.url="img/gpb,g.png";"other same shapes"==sel&&a.attributes[i].startsWith("same shape gp")&&(val=a.attributes[i].substring(13),b=!0,a.type="image",a.url="img/gp"+val+".png");if("similar shape"==sel&&("Boggs eumorphic"==a.label||
"Siemon IV"==a.label||"Putni\u0146\u0161 P1"==a.label||"Putni\u0146\u0161 P2"==a.label||"Putni\u0146\u0161 P3'"==a.label||"Putni\u0146\u0161 P4'"==a.label||"Wagner 1"==a.label||"Wagner 2"==a.label||"Wagner 3"==a.label)){"Boggs eumorphic"==a.label&&(b=!0,a.type="image",a.url="img/g-r.png");"Siemon IV"==a.label&&(b=!0,a.type="image",a.url="img/g-rk.png");if("Putni\u0146\u0161 P1"==a.label||"Putni\u0146\u0161 P2"==a.label)b=!0,a.type="image",a.url="img/gray-r.png";if("Putni\u0146\u0161 P3'"==a.label||
"Putni\u0146\u0161 P4'"==a.label)b=!0,a.type="image",a.url="img/gray-ok.png";if("Wagner 1"==a.label||"Wagner 2"==a.label||"Wagner 3"==a.label)b=!0,a.type="image",a.url="img/gray-o.png"}"(may be) interrupted"!=sel&&"Bonne group"!=sel||"Sinusoidal"!=a.label||(b=!0,a.type="image",a.url="img/gpb,g.png");"cylindrical equal-area family"!=sel&&"stretching"!=sel||!a.attributes[i].startsWith("cylindrical equal-area")||(b=!0,a.type="image",a.url="img/c,m.png");if("fusion"==sel&&"fusion-src"==a.attributes[i]||
